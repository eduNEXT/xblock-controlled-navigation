...
"""
xblock-controlled-navigation documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'xblock-controlled-navigation',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/edunext/xblock-controlled-navigation",
...
#
# html_title = 'xblock-controlled-navigation v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Used when course designers need to control the conditions under which a learner can access the contents of a subsection.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'controlled_navigation'),
                os.path.join(root_path, 'controlled_navigation/migrations')])
