#!/usr/bin/env python
"""
Package metadata for controlled_navigation.
"""
import os
import re
import sys
...
VERSION = get_version('controlled_navigation', '__init__.py')
...
setup(
    name='xblock-controlled-navigation',
    version=VERSION,
    description="""Used when course designers need to control the conditions under which a learner can access the contents of a subsection.""",
